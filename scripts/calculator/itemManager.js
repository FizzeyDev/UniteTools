...
export function updateItemCard(side, slot, item = null) {
  ...
  if (item.activable && item.name !== "Buddy Barrier" && item.name !== "Resonant Guard" && item.name !== "Score Shield" && item.name !== "Focus Band") {
  ...
  if (item.name === "Buddy Barrier" || item.name === "Resonant Guard" || item.name === "Score Shield" || item.name === "Focus Band") {
